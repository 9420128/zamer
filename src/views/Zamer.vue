<template>
    ...
    <form class="modal" @submit.prevent="zamerSubmit">
        <div class="modal__content">
            ...
            <div class="input-field">
                ...
                <input type="text" class="input" id="phone" v-model="phone" />
                <small class="helper-text invalid"></small>
            </div>

            <div class="input-field">
                <label for="date" class="required">Дата замера</label>
                <input type="date" class="input" id="date" v-model="date" />
                <small class="helper-text invalid"></small>
            </div>
